...
export function DateTimeInput({
  ...
  return (
    <div className={cn("grid min-w-0 gap-[7px]", fieldClassName)}>
      ...
      <span
        className={cn(
          "flex h-[50px] min-w-0 cursor-pointer items-center rounded-xl border border-border bg-surface px-3.5 transition-[border-color,box-shadow] duration-[160ms] ease-in-out focus-within:border-brand-secondary focus-within:shadow-[0_0_0_4px_rgba(106,0,255,0.12)]",
          shellClassName,
        )}
        onClick={(event) => {
