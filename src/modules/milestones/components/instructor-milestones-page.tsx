      ...
      <div className="grid max-h-[92vh] w-[min(720px,100%)] grid-rows-[auto_1fr] overflow-hidden rounded-2xl border border-border bg-surface shadow-modal">
        ...
        <form className="grid gap-5 overflow-y-auto p-6" onSubmit={handleSubmit}>
          ...
          <label className="grid gap-[7px]">
            ...
            <textarea
              className="min-h-28 rounded-xl border border-border bg-surface px-3.5 py-3 text-sm text-foreground outline-0 transition-[border-color,box-shadow] focus:border-brand-secondary focus:shadow-[0_0_0_4px_rgba(106,0,255,0.12)]"
          ...
          <label className="grid gap-[7px]">
            ...
            <input
              className="h-[50px] rounded-xl border border-border bg-surface px-3.5 text-sm outline-0 transition-[border-color,box-shadow] focus:border-brand-secondary focus:shadow-[0_0_0_4px_rgba(106,0,255,0.12)]"
