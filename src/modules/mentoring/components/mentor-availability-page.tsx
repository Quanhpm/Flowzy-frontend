...
function TimelineSlotCard({
  ...
  return (
    <button
      ...
      className={cn(
        "absolute z-10 grid min-h-9 min-w-0 cursor-pointer content-start gap-0.5 overflow-hidden rounded-lg border px-2 py-1.5 text-left shadow-card transition-[border-color,box-shadow,transform] duration-[160ms] focus-visible:z-20 focus-visible:outline-0 focus-visible:shadow-[0_0_0_4px_rgba(106,0,255,0.16)] active:scale-[0.99]",
        ...
        {weekDays.map((date, index) => {
          ...
          return (
            <button
              ...
              className={cn(
                "grid min-h-14 min-w-0 place-items-center gap-0.5 rounded-xl border px-1 py-2 text-center transition-[background,border-color,color,box-shadow] duration-[160ms] focus-visible:outline-0 focus-visible:shadow-[0_0_0_4px_rgba(106,0,255,0.16)]",
                isSelected
